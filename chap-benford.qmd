...
This will open a dataset with two columns: 'ID' and 'value'. The 'ID' column represents the identification number of the items in the population. The 'value' column shows the recorded values of the items.
...
- **Tables: Matched rows:** Check this box to display a table showing the rows that have a certain number as their leading/last digit(s).
  ...
  ![](img/benford/benford-7.png){fig-align="center" width=40%}
