...
The Audit module is a part of JASP, which can be downloaded freely from [www.jasp-stats.org](www.jasp-stats.org). Upon clicking the Download JASP button on the website's home page you will be directed to the download page, where you are able to choose your preferred installation. JASP is available for Windows, MacOS, Linux, and Chrome OS. The installation of the software proceeds as you are used to.
