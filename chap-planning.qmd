...
The Audit module includes an analysis called 'Bayesian Planning,' which is a variant of the planning analysis. This enhanced analysis offers additional options beyond those available in the classical planning analysis, emphasizing the integration of various types of pre-existing audit information.
