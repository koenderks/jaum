...
## The four states of the sampling workflow
...
For a more detailed explanation of the options and output in the planning stage, see @sec-planning.
...
1. **Annotation method:** First, decide how to annotate the selected items. You have two options:
...
2. **Column names:** Next, specify the names of the two columns that will be added to the dataset. The first column name will indicate the result of the selection, while the second column name will contain the annotation of the items. Click the 'Continue' button to confirm the options and open the data viewer.
